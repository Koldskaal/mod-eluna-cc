...
luaL_Reg GlobalMethods[] =
    {
        ...
        // CRAFTCRAFT CUSTOM GLOBAL
        {"GetTalentEntry", &LuaGlobalFunctions::GetTalentEntry},
        {"GetTalentCount", &LuaGlobalFunctions::GetTalentCount},
...
ElunaRegister<Player> PlayerMethods[] =
    {
        ...
        {"LootCorpse", &LuaPlayer::LootCorpse}, // custom #1212
...
// {"HasReceivedQuestReward", &LuaPlayer::HasReceivedQuestReward},                      // :HasReceivedQuestReward(entry) - UNDOCUMENTED - Returns true if the player has recieved the quest's reward
        ...
        // CRAFTCRAFT CUSTOM
        {"GetSecondaryClass", &LuaPlayer::GetSecondaryClass},
        {"SetSecondaryClass", &LuaPlayer::SetSecondaryClass},
